...
​Telefon numarası alanına harf girilmesini engelleyen güvenlik kontrolü.
​Tutar (Miktar) kısımlarına sadece geçerli sayısal değerlerin girilmesini sağlayan sistem.
​Teknik Detaylar:
​Backend: PHP 8+ / Laravel
​Frontend: Blade Templates, CSS, JavaScript (Modal işlemleri için).
​Veritabanı: MySQL (İlişkisel veritabanı yapısı ile müşteri ve ödeme tabloları).
